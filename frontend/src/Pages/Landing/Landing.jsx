            ...
            <Row className="row-cols-1 row-cols-sm-3">
              <Col className="mb-4 mb-sm-0">
                <div className="d-flex flex-column">
                  ...
                  <p className="mb-0">
                    Пока наша среда разработки запускает код только на
                    JavaScript. В ближайшем будущем мы реализуем в редакторе
              ...
              <Col className="mb-4 mb-sm-0">
                <div className="d-flex flex-column">
                  ...
                  <p className="mb-0">
                    Вы сможете делиться ссылкой на фрагменты своего кода с
                    другими участниками. Или работать вместе прямо в Runit!
                  </p>
                </div>
              </Col>
              <Col className="mb-4 mb-sm-0">
                <div className="d-flex flex-column">
                  ...
                  <p className="mb-0">
                    ...
                    Мы сделаем шаблоны, чтобы вы могли проверить свои идеи на
