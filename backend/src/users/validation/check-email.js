...
var CheckEmail = /** @class */ (function () {
    function CheckEmail(usersService) {
        this.usersService = usersService;
    }
    CheckEmail.prototype.validate = function (text, validationArguments) {
        return __awaiter(this, void 0, void 0, function () {
            var email, object, exists;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        email = validationArguments.value;
                        object = validationArguments.object;
                        return [4 /*yield*/, this.usersService.find(email)];
                    case 1:
                        exists = _a.sent();
                        if (object['id'] && exists) {
