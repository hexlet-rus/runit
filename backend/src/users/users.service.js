...
var UsersService = /** @class */ (function () {
    function UsersService(usersRepository, snippetsRepository) {
    ...
    UsersService.prototype.findByLogin = function (login) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.usersRepository.findOneBy({ login: login })];
            });
        });
    };
    UsersService.prototype.create = function (createUserDto) {
        var user = new user_entity_1.Users();
    ...
    UsersService.prototype.update = function (id, updateUserDto) {
        return __awaiter(this, void 0, void 0, function () {
            var currPassword, confirmPassword, data, currentUser, updatedUser;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        currPassword = updateUserDto.currPassword, confirmPassword = updateUserDto.confirmPassword, data = __rest(updateUserDto, ["currPassword", "confirmPassword"]);
                        return [4 /*yield*/, this.usersRepository.findOneBy({ id: id })];
                    case 1:
                        currentUser = _a.sent();
                        updatedUser = this.usersRepository.merge(currentUser, data);
                        return [4 /*yield*/, this.usersRepository.save(updatedUser)];
                    case 2:
                        _a.sent();
    ...
    UsersService.prototype.getData = function (_a) {
        var id = _a.id;
        return __awaiter(this, void 0, void 0, function () {
            var currentUser, snippets;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this.usersRepository.findOneBy({ id: id })];
                    case 1:
                        currentUser = _b.sent();
                        return [4 /*yield*/, this.snippetsRepository.find({
                                relations: {
                                    user: true
                                },
                                where: {
                    ...
                    case 2:
                        snippets = _b.sent();
                        return [2 /*return*/, { currentUser: currentUser, snippets: snippets }];
                }
            });
        });
    };
